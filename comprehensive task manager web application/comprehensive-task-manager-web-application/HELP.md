...
* The original package name 'com.project.personal.comprehensive task manager web application' is invalid and this project uses 'com.project.personal.comprehensive.task.manager.web.application' instead.
